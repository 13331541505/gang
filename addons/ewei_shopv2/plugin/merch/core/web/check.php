...
class Check_EweiShopV2Page extends PluginWebPage
{
	...
	{
		include $this->template('merch/check/form');
	}
	public function detail()
	{
		...
		if ($_GPC['export'] == '1') {
			...
			$columns[] = array('title' => '可提现金额', 'field' => 'mch_fan', 'width' => 24);
			$columns[] = array('title' => '抽成前金额', 'field' => 'price', 'width' => 12);
			$columns[] = array('title' => '用户返利', 'field' => 'user_fan', 'width' => 24);
			$columns[] = array('title' => '实物奖池扣除', 'field' => 'shiwu', 'width' => 24);
			$columns[] = array('title' => '你消我买扣除', 'field' => 'xiao', 'width' => 24);
			$columns[] = array('title' => '关联售卖扣除', 'field' => 'guan', 'width' => 24);
