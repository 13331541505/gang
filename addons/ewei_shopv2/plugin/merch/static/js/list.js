                ...
                t.getCurrentPosition(function(t, e) {
                    ...
                    n.getMerch();
                        ...
                        i.getCurrentPosition(function(t) {
                            this.getStatus() == BMAP_STATUS_SUCCESS ? (n.setCookie("lat", t.point.lat, .1), n.setCookie("lng", t.point.lng, .1), n.lat = t.point.lat, n.lng = t.point.lng, n.getMerch()) : FoxUI.toast.show("位置获取失败!")
                        },
                        {
                            enableHighAccuracy: !0
                        })
