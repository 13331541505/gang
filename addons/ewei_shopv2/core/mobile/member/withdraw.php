...
class Withdraw_EweiShopV2Page extends MobileLoginPage
{
	...
	public function submit()
	{
		...
		//2021-7-20 sy
		// m('member')->setCredit($_W['openid'], 'credit2', 0 - $money);
		$m = pdo_get('ewei_shop_member',array('openid'=>$_W['openid']));

		pdo_fetch("update ".tablename('mc_members').' set credit2 = credit2-'.$money.' where uid='.$m['uid']);
