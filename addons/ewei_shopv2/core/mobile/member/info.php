...
class Info_EweiShopV2Page extends MobileLoginPage
{
	...
	public function submit()
	{
		...
		if ($template_flag == 1) {
			...
			$arr = array('realname' => trim($memberdata['realname']), 'weixin' => trim($memberdata['weixin']), 'birthyear' => intval($memberdata['birthyear']), 'birthmonth' => intval($memberdata['birthmonth']), 'birthday' => intval($memberdata['birthday']), 'province' => trim($memberdata['province']), 'city' => trim($memberdata['city']), 'datavalue' => trim($memberdata['datavalue']), 'mobile' => trim($memberdata['mobile']),'gender'=>trim($memberdata['gender']),'nickname' => trim($memberdata['nickname']), 'avatar' => trim($memberdata['avatar']));
