		...
		$allUrls = array(
			...
			array(
				...
				'list' => array(
					...
					array('name' => '集奖商品', 'url' => mobileUrl('goods', array('issendfree' => 1), $full), 'url_wxapp' => '/pages/goods/index/index?issendfree=1'),
			...
			array(
				...
				'list' => array(
					...
					4  => array('name' => '待核销订单', 'url' => mobileUrl('order', array('status' => 2), $full), 'url_wxapp' => '/pages/order/index?status=2'),
