...
$res = pdo_get('ewei_mch_money',array('in_id'=>$id,'type'=>2));
// var_dump(211);die;
...
if ($_W['ispost']) {
	...
	if (empty($id)) {
		...
		$data1['zhuan_num'] = $_GPC['zhuan_num'];
		...
		$data1['mch_money'] = $_GPC['mch_money'];
		$data1['zhuan_num'] = $_GPC['zhuan_num'];
		pdo_update('ewei_mch_money', $data1, array('in_id' => $id,'type'=>2));
...
$merch = pdo_get('ewei_shop_merch_user',array('id'=>$item['merchid']));
