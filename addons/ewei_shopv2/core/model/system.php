		...
		$shopmenu = array(
			...
			'order'      => array(
				...
				'items'    => array(
					...
					array('title' => '待核销', 'route' => 'list.status2', 'desc' => '待收货订单管理'),
			...
			'game' => array(
				...
				'items'    => array(
					array(
						'title' => '游戏列表',
						'items' => array(
							array('title' => '游戏列表', 'route' => 'index'),
							array('title' => '添加游戏', 'route' => 'add'),
							array('title' => '核销设置', 'route' => 'memberhexiao')
						)
					),
					// array(
					// 	'title' => '发放记录',
				...
				'items'    => array(
					...
					array(
						...
						'items' => array(
							...
							array('title' => '银行设置', 'route' => 'commission')
						)
					),
					array(
						'title' => '消息推送',
