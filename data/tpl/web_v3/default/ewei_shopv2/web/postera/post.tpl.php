    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php if( ce('postera' ,$item) ) { ?>
                <input type="submit" value="保存并预览" name="preview_submit" class="btn btn-success"  id="preview" />

                <input type="submit" value="提交"  name="normal_submit" class="btn btn-primary"  id="normal" />
...
<script language='javascript'>
    ...
    $('#preview').unbind().click(
        function () {
            $(':input[name=submit_type]').val(2);
        }
    );
    $('#normal').unbind().click(
        function () {
            $(':input[name=submit_type]').val(1);
        }
    );
