            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <select class="form-control" onclick="$('.tm').hide();$('.tm-' + $(this).val()).show()">
                        ...
                        <?php  } ?>
                        <?php  if(cv('friendcoupon')) { ?>
                        <option value="friendcoupon">好友瓜分券类</option>
                        <?php  } ?>
                ...
                <div class="panel-heading tm tm-friendcoupon" style="display:none">好友瓜分券类</div>
                <div class="panel-body tm tm-friendcoupon" style="display:none">
                    <a href='JavaScript:' class="btn btn-default btn-sm">活动名称</a>
                    <a href='JavaScript:' class="btn btn-default btn-sm">活动开始时间</a>
                    <a href='JavaScript:' class="btn btn-default btn-sm">活动结束时间</a>
                    <a href='JavaScript:' class="btn btn-default btn-sm">瓜分券领取时间</a>
                    <a href='JavaScript:' class="btn btn-default btn-sm">瓜分券名称</a>
                </div>
