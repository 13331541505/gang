<?php defined('IN_IA') or exit('Access Denied');?>
   <div id="page-loading">
    ...
    <div class="copyright"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?> 源码来自 <a href="https://bbs.mswiner.com"><b>共赢源码</b></a> v<?php echo IMS_VERSION;?> © 2015-2019<?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></div>
