...
<div class="system-login" <?php  if(!empty($_W['setting']['copyright']['background_img']) && function_exists('to_global_media')) { ?> style="background-image:url('<?php  echo to_global_media($_W['setting']['copyright']['background_img']);?>')" <?php  } else { ?> style="background-image: url('./resource/images/login_bg.jpg');" <?php  } ?>>
