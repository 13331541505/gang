...
<div class="fui-page cav order_detail">
				...
				<div class="fui-according-content">
					<div class="content-block">
						<div class="fui-cell-group notop store-container">
							<?php  if($order['merchid'] > 0) { ?>
							<a href="<?php  echo mobileUrl('store/detail',array('id'=>$store['id'], 'merchid'=>$order['merchid']))?>" class="fui-cell">
							<?php  } else { ?>
	...
	<div class="fui-cell-group">
		...
		<div class="fui-cell">
			...
			<?php  if($order['islink'] == 1) { ?>
			<div class="fui-cell-info" style="white-space: normal;word-wrap: break-word"><a href="<?php  echo $ordervirtualrow['value'];?>"><?php  echo $ordervirtualrow['value'];?></a></div>
			<?php  } else { ?>
