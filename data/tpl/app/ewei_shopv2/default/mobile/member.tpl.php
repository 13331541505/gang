 ...
 <!--   <div class="fui-header">-->
	...
	<div class='fui-content member-page navbar' style="top:0;">
		...
		<div class='member_card'>
			...
			<div class='title' style="font-size:17px;">会员中心</div>
	...
	<div class="fui-cell-group fui-cell-click" style="margin-top: 0">
		...
		<div class="fui-icon-group selecter <?php  if($check_cycelbuy) { ?>col-5<?php  } else { ?>col-4<?php  } ?>">
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>0))?>">
				...
				<div class="icon icon-green radius"><i class="icon icon-xiangmuzhouqi"></i></div>
			...
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order')?>">
				...
				<div class="icon icon-pink radius"><i class="icon icon-daifukuan1"></i></div>
