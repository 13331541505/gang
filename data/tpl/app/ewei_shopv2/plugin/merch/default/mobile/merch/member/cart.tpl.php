...
<div class='fui-page  fui-page-current member-cart-page'>
	...
	<script type="text/html" id="tpl_member_cart">
			...
			<img src="<?php echo EWEI_SHOPV2_STATIC;?>images/nogoods.png" style="width: 6rem;margin-bottom: .5rem;"><br/><p style="color: #999;font-size: .75rem">您的购物车中没有商品哦！</p><br/><a href="<?php  echo mobileUrl($route)?>" class='btn btn-sm btn-danger-o external'
			...
			<div class="fui-list noclick">
				...
				<div class="fui-list-media">
					<label class="checkbox-inline checkall">
						<input type="checkbox" name="checkbox" class="fui-radio fui-radio-danger " <%if ischeckall%>checked<%/if%>/>&nbsp;全选</label>
				</div>
				<div class="fui-list-inner">
